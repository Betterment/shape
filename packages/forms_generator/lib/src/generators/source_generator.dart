...
abstract class SourceGenerator {
  ...
  void writeClassConstructor({
    ...
    assert(
      ...
      'Cannot provide private parameters for a constructor with named parameters.',
    );
    ...
    if (supertypeConstructorName != null) {
      _writeln(
        ...
        ' : super.$supertypeConstructorName'
        '(${!passParametersToSuper ? '' : privateInstanceParameterNames.join()})',
      );
    }
