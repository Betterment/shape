...
class FormsGenerator extends GeneratorForAnnotation<GenerateFormBody> {
  @override
  FutureOr<String> generateForAnnotatedElement(
    ...
    final isRunningNullSafe = await _isRunningNullSafe(element, buildStep);
    GeneratorContext.instance =
        GeneratorContext(isNullSafetyEnabled: isRunningNullSafe);
...
forms_generator only supports return statements that are immediately followed
...
considered a bug in the forms_generator package. Please report it.
...
forms_generator package. Please report it.
